# Haerriz Google Shopping Feed for Magento 2 (v2.1.0)
...
- **Merchant API v1 Integration**: Communicates directly with Google Merchant Center using secure service-account authentication.
- **Google setup requirement**: Enable Merchant API and register the Google Cloud project with the Merchant Center account before testing service-account access.
